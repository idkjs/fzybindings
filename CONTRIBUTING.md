...
The following snippet describes fzy_bindings's repository structure.

```text
.
├── bin/
|   Source for fzybindings's binary. This links to the library defined in `lib/`.
│
├── lib/
|   Source for fzy_bindings's library. Contains fzy_bindings's core functionnalities.
│
├── test/
|   Unit tests and integration tests for fzy_bindings.
│
├── dune-project
